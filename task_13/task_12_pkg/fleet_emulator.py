...
class Fleet(Node):
    ...
    def __init__(self, robot_name, x, y, priority):
        ...
        self.declare_parameter('robot_position', float(x))
        self.current_y = y
        self.declare_parameter('robot_priority', priority)
        self.current_x = self.get_parameter('robot_position').get_parameter_value().double_value
